...
- **Trợ lý thông minh RAG AI Chatbot:** Tích hợp trực tiếp hệ thống Hỏi - Đáp tri thức thông minh (Retrieval-Augmented Generation) liên kết cơ sở dữ liệu Vector (PGVector) và OpenAI/Gemini Embeddings. Kỹ thuật viên có thể trò chuyện trực tiếp với AI để nhận câu trả lời nhanh chóng cho các sự cố kỹ thuật dựa trên chính SOP nội bộ của doanh nghiệp, kèm theo nguồn trích dẫn chính xác (chỉ rõ tài liệu và phân đoạn gốc).
...
Dưới đây là **Sơ đồ Use Case (Tương tác hệ thống)** tổng quan, thể hiện vai trò của từng nhóm người dùng đối với các tính năng lõi bao gồm Hỏi đáp RAG AI Chat:
...
- Hỏi đáp thông minh RAG AI Chatbot tự động đọc hiểu file Word (DOCX) và PDF để hỗ trợ kỹ thuật viên tức thời.
...
- Hệ thống kiểm thử bảo mật E2E tự động cô lập Multi-Tenant đảm bảo tính toàn vẹn dữ liệu.

**Đối tượng sử dụng (Target Audience):**

- **Nhân viên IT / Kỹ thuật viên (IT Staffs / Helpdesk):** Đối tượng sử dụng chính, cần truy cập nhanh vào kho kiến thức để xử lý ticket và sự cố hàng ngày, trò chuyện trực tiếp với AI để giải quyết nhanh ticket kỹ thuật.
- **Quản lý IT / Trưởng nhóm (IT Managers / Team Leads):** Người chịu trách nhiệm phê duyệt, ban hành các quy trình chuẩn, kiểm toán nhật ký thao tác và quản lý nhân sự trong tổ chức.
